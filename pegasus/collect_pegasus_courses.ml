...
let keywords_list =
  [
    ...
    Public_data.PEGASUS_CO_PRODUIT_FR_ENS_SAD_INTRODUCTION	;
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_SAD_PRINCIPES_GENERAUX;	
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_SAD_CONDITIONS_OBTENTN;	
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_SAD_INTITULE_DIPLOME	;
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_ETABLISSEMENT_DELIVRE	;
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_ETABLISSEMENT_DISPENCE;	
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_CONDITIONS_ACCES	;
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_DUREE_PROGRAMMES	;
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_LANGUES_ENSEIGNEMENT	;
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_NIVEAU_DE_QUALIFICATION	;
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_ORGANISATION_DES_ETUDES;	
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_EXIGENCES_DU_PROGRAMME;	
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_SIGNATAIRE;	
  Public_data.PEGASUS_CO_PRODUIT_ENS_SIGNATURE	;
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_SAD_INTRODUCTION	;
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_SAD_PRINCIPES_GENERAUX;	
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_SAD_CONDITIONS_OBTENTN;	
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_SAD_INTITULE_DIPLOME	;
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_ETABLISSEMENT_DELIVRE	;
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_ETABLISSEMENT_DISPENCE;	
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_CONDITIONS_ACCES	;
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_DUREE_PROGRAMMES	;
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_LANGUES_ENSEIGNEMENT	;
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_NIVEAU_DE_QUALIFICATION	;
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_ORGANISATION_DES_ETUDES;	
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_EXIGENCES_DU_PROGRAMME;	
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_SIGNATAIRE	;
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_TYPE_EDITION;	
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_SIGNATAIRE	;
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_SIGNATAIRE_GB;	
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_SIGNATURE	;
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_AFFICHE_MIN_MAX_MOY;	
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_AFFICHE_ABSENCES;	
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_BULL_LEGENDE	;
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_BULL_LEGENDE	;
  Public_data.PEGASUS_CO_PRODUIT_ENS_DOMAINE_DIPLOME	;
  Public_data.PEGASUS_CO_PRODUIT_ENS_DOMAINE_DIPLOME_GB;	
  Public_data.PEGASUS_CO_PRODUIT_ENS_ENTETE_DIPLOME	;
  Public_data.PEGASUS_CO_PRODUIT_ENS_SIGNATAIRE_ETABLISSEMENT;	
  Public_data.PEGASUS_CO_PRODUIT_ENS_SIGNATAIRE_ETAB_GB	;
  Public_data.PEGASUS_CO_PRODUIT_ENS_SIGNATAIRE_UNIVERSITE_PSL;	
  Public_data.PEGASUS_CO_PRODUIT_ENS_SIGNATAIRE_ACADEMIE;	
  Public_data.PEGASUS_CO_PRODUIT_ADD_TITRE_DU_DECLARANT;	
  Public_data.PEGASUS_CO_PRODUIT_ADD_NOM_DU_DIPLOME	;
  Public_data.PEGASUS_CO_PRODUIT_ADD_COMPLEMENT_INFO;	
  Public_data.PEGASUS_CO_PRODUIT_ADD_SIGNATAIRE;	
  Public_data.PEGASUS_CO_PRODUIT_SISE_COMPOS;
  Public_data.PEGASUS_CO_PRODUIT_SISE_DIPLOM ;
    ...
    Public_data.PEGASUS_ENSEIGNANT_4 ;
    Public_data.PEGASUS_ENSEIGNANT_5 ;
    Public_data.PEGASUS_ENSEIGNANT_6 ;
...
let add_non_empty l data m = 
  List.fold_left 
    (fun m k -> 
      if k = "" then m 
      else Public_data.StringMap.add k data m)
    m l 

let make_dictionary state = 
  let state, map = Remanent_state.Collector_course_pegasus.get state in 
  let state, pedagogical_courses_dictionnary = 
