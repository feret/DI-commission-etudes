...
type keywords =
  ...
  | PEGASUS_CO_PRODUIT_FR_ENS_SAD_INTRODUCTION	
  | PEGASUS_CO_PRODUIT_FR_ENS_SAD_PRINCIPES_GENERAUX	
  | PEGASUS_CO_PRODUIT_FR_ENS_SAD_CONDITIONS_OBTENTN	
  | PEGASUS_CO_PRODUIT_FR_ENS_SAD_INTITULE_DIPLOME	
  | PEGASUS_CO_PRODUIT_FR_ENS_ETABLISSEMENT_DELIVRE	
  | PEGASUS_CO_PRODUIT_FR_ENS_ETABLISSEMENT_DISPENCE	
  | PEGASUS_CO_PRODUIT_FR_ENS_CONDITIONS_ACCES	
  | PEGASUS_CO_PRODUIT_FR_ENS_DUREE_PROGRAMMES	
  | PEGASUS_CO_PRODUIT_FR_ENS_LANGUES_ENSEIGNEMENT	
  | PEGASUS_CO_PRODUIT_FR_ENS_NIVEAU_DE_QUALIFICATION	
  | PEGASUS_CO_PRODUIT_FR_ENS_ORGANISATION_DES_ETUDES	
  | PEGASUS_CO_PRODUIT_FR_ENS_EXIGENCES_DU_PROGRAMME	
  | PEGASUS_CO_PRODUIT_FR_ENS_SIGNATAIRE	
  | PEGASUS_CO_PRODUIT_ENS_SIGNATURE	
  | PEGASUS_CO_PRODUIT_GB_ENS_SAD_INTRODUCTION	
  | PEGASUS_CO_PRODUIT_GB_ENS_SAD_PRINCIPES_GENERAUX	
  | PEGASUS_CO_PRODUIT_GB_ENS_SAD_CONDITIONS_OBTENTN	
  | PEGASUS_CO_PRODUIT_GB_ENS_SAD_INTITULE_DIPLOME	
  | PEGASUS_CO_PRODUIT_GB_ENS_ETABLISSEMENT_DELIVRE	
  | PEGASUS_CO_PRODUIT_GB_ENS_ETABLISSEMENT_DISPENCE	
  | PEGASUS_CO_PRODUIT_GB_ENS_CONDITIONS_ACCES	
  | PEGASUS_CO_PRODUIT_GB_ENS_DUREE_PROGRAMMES	
  | PEGASUS_CO_PRODUIT_GB_ENS_LANGUES_ENSEIGNEMENT	
  | PEGASUS_CO_PRODUIT_GB_ENS_NIVEAU_DE_QUALIFICATION	
  | PEGASUS_CO_PRODUIT_GB_ENS_ORGANISATION_DES_ETUDES	
  | PEGASUS_CO_PRODUIT_GB_ENS_EXIGENCES_DU_PROGRAMME	
  | PEGASUS_CO_PRODUIT_GB_ENS_SIGNATAIRE	
  | PEGASUS_CO_PRODUIT_ENS_BULL_TYPE_EDITION	
  | PEGASUS_CO_PRODUIT_ENS_BULL_SIGNATAIRE	
  | PEGASUS_CO_PRODUIT_ENS_BULL_SIGNATAIRE_GB	
  | PEGASUS_CO_PRODUIT_ENS_BULL_SIGNATURE	
  | PEGASUS_CO_PRODUIT_ENS_BULL_AFFICHE_MIN_MAX_MOY	
  | PEGASUS_CO_PRODUIT_ENS_BULL_AFFICHE_ABSENCES	
  | PEGASUS_CO_PRODUIT_FR_ENS_BULL_LEGENDE	
  | PEGASUS_CO_PRODUIT_GB_ENS_BULL_LEGENDE	
  | PEGASUS_CO_PRODUIT_ENS_DOMAINE_DIPLOME	
  | PEGASUS_CO_PRODUIT_ENS_DOMAINE_DIPLOME_GB	
  | PEGASUS_CO_PRODUIT_ENS_ENTETE_DIPLOME	
  | PEGASUS_CO_PRODUIT_ENS_SIGNATAIRE_ETABLISSEMENT	
  | PEGASUS_CO_PRODUIT_ENS_SIGNATAIRE_ETAB_GB	
  | PEGASUS_CO_PRODUIT_ENS_SIGNATAIRE_UNIVERSITE_PSL	
  | PEGASUS_CO_PRODUIT_ENS_SIGNATAIRE_ACADEMIE	
  | PEGASUS_CO_PRODUIT_ADD_TITRE_DU_DECLARANT	
  | PEGASUS_CO_PRODUIT_ADD_NOM_DU_DIPLOME	
  | PEGASUS_CO_PRODUIT_ADD_COMPLEMENT_INFO	
  | PEGASUS_CO_PRODUIT_ADD_SIGNATAIRE	
  | PEGASUS_CO_PRODUIT_SISE_COMPOS	
  | PEGASUS_CO_PRODUIT_SISE_DIPLOM
  ...
  | PEGASUS_CO_ANNEE_CREDITS_MINIMUM_POUR_VALIDER	
  | PEGASUS_CO_ANNEE_ENS_VISA_DIPLOME	
  | PEGASUS_CO_ANNEE_ENS_VISA_DIPLOME_CO_ACCRED
  | PEGASUS_NOTES_SAISIE_DIRECTE 
  | PEGASUS_ENS_CE_PERIODE_DE_L_ANNEE 
  | PEGASUS_STAGE 
  | PEGASUS_GENRE
  | PEGASUS_CODE_SEXE
  | PEGASUS_NOM
  ...
  | PEGASUS_ENSEIGNANT_4
  | PEGASUS_ENSEIGNANT_5 
  | PEGASUS_ENSEIGNANT_6 
  | PEGASUS_ENSEIGNANT_7
  | PEGASUS_ENSEIGNANT_8
  | PEGASUS_ENSEIGNANT_9 
  | PEGASUS_ENSEIGNANT_10
  | PEGASUS_INTITULE 
...
type pedagogical_registration_suggestion = 
   {
      transfert_to_another_diploma: (cours_supplement *
...
type exp_allocation = 
    ...
    (string * (diploma_level * main_dpt option))) list 

   
type exp_allocation_map = 
  ((string * (diploma_level option * main_dpt option)) * 
    (string * (diploma_level * main_dpt option))) StringMap.t
