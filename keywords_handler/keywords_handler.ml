...
let asso_list =
  [
    ...
    Public_data.PEGASUS_Nature_de_l_activite,["nature de l'activité";"TYPE_D_ACTION"];
    ...
    Public_data.PEGASUS_CO_PRODUIT_ID_GIROFLE,["co_produit id_girofle";"ID_GIROFLE"]; 
  ...
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_SAD_INTRODUCTION,["co_produit fr_ens_sad_introduction"];
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_SAD_PRINCIPES_GENERAUX	,["co_produit fr_ens_sad_principes_generaux"];
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_SAD_CONDITIONS_OBTENTN	,["co_produit fr_ens_sad_conditions_obtentn"];
  ...
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_SAD_PRINCIPES_GENERAUX	,["co_produit gb_ens_sad_principes_generaux"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_SAD_CONDITIONS_OBTENTN	,["co_produit gb_ens_sad_conditions_obtentn"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_SAD_INTITULE_DIPLOME	,["co_produit gb_ens_sad_intitule_diplome"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_ETABLISSEMENT_DELIVRE	,["co_produit gb_ens_etablissement_delivre"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_ETABLISSEMENT_DISPENCE	,["co_produit gb_ens_etablissement_dispence"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_CONDITIONS_ACCES	,["co_produit gb_ens_conditions_acces"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_DUREE_PROGRAMMES	,["co_produit gb_ens_duree_programmes"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_LANGUES_ENSEIGNEMENT	,["co_produit gb_ens_langues_enseignement"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_NIVEAU_DE_QUALIFICATION	,["co_produit gb_ens_niveau_de_qualification"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_ORGANISATION_DES_ETUDES	,["co_produit gb_ens_organisation_des_etudes"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_EXIGENCES_DU_PROGRAMME	,["co_produit gb_ens_exigences_du_programme"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_SIGNATAIRE	,["co_produit gb_ens_signataire"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_TYPE_EDITION	,["co_produit ens_bull_type_edition"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_SIGNATAIRE	,["co_produit ens_bull_signataire"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_SIGNATAIRE_GB	,["co_produit ens_bull_signataire_gb"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_SIGNATURE	,["co_produit ens_bull_signature"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_AFFICHE_MIN_MAX_MOY	,["co_produit ens_bull_affiche_min_max_moy"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_BULL_AFFICHE_ABSENCES	,["co_produit ens_bull_affiche_absences"];
  Public_data.PEGASUS_CO_PRODUIT_FR_ENS_BULL_LEGENDE	,["co_produit fr_ens_bull_legende"];
  Public_data.PEGASUS_CO_PRODUIT_GB_ENS_BULL_LEGENDE	,["co_produit gb_ens_bull_legende"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_DOMAINE_DIPLOME	,["co_produit ens_domaine_diplome"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_DOMAINE_DIPLOME_GB	,["co_produit ens_domaine_diplome_gb"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_ENTETE_DIPLOME	,["co_produit ens_entete_diplome"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_SIGNATAIRE_ETABLISSEMENT	,["co_produit ens_signataire_etablissement"];
  Public_data.PEGASUS_CO_PRODUIT_ENS_SIGNATAIRE_ETAB_GB	,["co_produit ens_signataire_etab_gb"];
  ...
  Public_data.PEGASUS_CO_PRODUIT_SISE_DIPLOM,["co_produit sise-diplom"];
    ...
    Public_data.PEGASUS_NV_0,["NV_0"]; 
    Public_data.PEGASUS_NV_1,["NV_1"]; 
    Public_data.PEGASUS_NV_2,["NV_2"]; 
    Public_data.PEGASUS_C1,["C1"]; 
    Public_data.PEGASUS_C2,["C2"]; 
    Public_data.PEGASUS_C3,["C3"]; 
    Public_data.PEGASUS_C4,["C4"]; 
    Public_data.PEGASUS_C5,["C5"]; 
    Public_data.PEGASUS_C6,["C6"]; 
    Public_data.PEGASUS_C7,["C7"]; 
    Public_data.PEGASUS_C8,["C8"]; 
    ...
    Public_data.PEGASUS_LIEU_SESSION,["LIEU_SESSION"]; 
    Public_data.PEGASUS_COMPTE,["COMPTE"]; 
    ...
    Public_data.PEGASUS_RESPONSABLE_ADMINISTRATIF,["RESPONSABLE_ADMINISTRATIF"]; 
    Public_data.PEGASUS_ENS_CE_EMAIL_RDD_01,["ENS-CE-EMAIL_RDD_01"]; 
    Public_data.PEGASUS_ENS_CE_EMAIL_RDD_02,["ENS-CE-EMAIL_RDD_02"]; 
    Public_data.PEGASUS_COURS_OBL_CODES_PRODUITS,["COURS-OBL-CODES_PRODUITS"]; 
    Public_data.PEGASUS_COURS_OBL_PHASES_PROS,["COURS-OBL-PHASES_PROS"]; 
    Public_data.PEGASUS_MOODLE_ENSEIGNEMENT_FERME,["MOODLE_.ENSEIGNEMENT_FERME"]; 
    Public_data.PEGASUS_CHG_VALID,["CHG VALID"]; 
    Public_data.PEGASUS_dh_DUREE_HEURE,["dh=DUREE HEURE"]; 
    Public_data.PEGASUS_ng_NOMBRE_GROUPES,["ng=NOMBRE GROUPES"]; 
    ...
    Public_data.PEGASUS_ENSEIGNANT_2,["ENSEIGNANT 2"]; 
    Public_data.PEGASUS_ENSEIGNANT_3,["ENSEIGNANT 3"]; 
    Public_data.PEGASUS_ENSEIGNANT_4,["ENSEIGNANT 4"]; 
    Public_data.PEGASUS_ENSEIGNANT_5,["ENSEIGNANT 5"]; 
    Public_data.PEGASUS_ENSEIGNANT_6,["ENSEIGNANT 6"]; 
    Public_data.PEGASUS_ENSEIGNANT_7,["ENSEIGNANT 7"]; 
    Public_data.PEGASUS_ENSEIGNANT_8,["ENSEIGNANT 8"]; 
    Public_data.PEGASUS_ENSEIGNANT_9,["ENSEIGNANT 9"]; 
    Public_data.PEGASUS_ENSEIGNANT_10,["ENSEIGNANT 10"]; 
    Public_data.PEGASUS_INTITULE,["INTITULE"]; 
    Public_data.PEGASUS_INTITULE_ANGLAIS,["INTITULE_ANGLAIS"]; 
    Public_data.PEGASUS_MOTS_CLES,["MOTS-CLES"]; 
    Public_data.PEGASUS_MOTS_CLES_ANGLAIS,["MOTS-CLES_ANGLAIS"]; 
    Public_data.PEGASUS_OBJECTIFS,["OBJECTIFS"]; 
    Public_data.PEGASUS_OBJECTIFS_ANGLAIS,["OBJECTIFS_ANGLAIS"]; 
    Public_data.PEGASUS_PROGRAMME,["PROGRAMME"]; 
    Public_data.PEGASUS_PROGRAMME_ANGLAIS,["PROGRAMME_ANGLAIS"]; 
    Public_data.PEGASUS_PREREQUIS,["PREREQUIS"]; 
    Public_data.PEGASUS_PREREQUIS_ANGLAIS,["PREREQUIS_ANGLAIS"]; 
    Public_data.PEGASUS_MODALITE_D_EVAL,["MODALITE D EVAL"]; 
